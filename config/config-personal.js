	...
	modules: [
		...
		},
		{
			...
			config: {
				...
				// Preview is off. The map now follows the real feed: it stays
				// hidden until a trip is made current and a stop is published,
				// and the Bitcoin price holds the slot until then.
				testMode: false,
			}
		},
		{
